          ...
          <AnimatedSection delay={0.3}>
            <div className="order-2 lg:order-none">
              <div className="space-y-6 text-center lg:text-left px-4 xs:px-6 sm:px-8 lg:px-0">
                <div className="space-y-4 text-sm xs:text-base" style={{ color: 'var(--color-text-secondary)', fontWeight: 400 }}>
                  <p className="text-xl lg:text-2xl" style={{ color: 'var(--color-text-primary)', fontWeight: 400 }}>
                    Marci Metzger
                  </p>
                  <p className="text-lg" style={{ color: 'var(--color-text-primary)', fontWeight: 400 }}>
                  ...
                  <div className="pt-4 border-t" style={{ borderColor: 'var(--color-muted-gold)' }}>
                    <p className="mb-3 flex items-center gap-2 justify-center lg:justify-start" style={{ color: 'var(--color-text-primary)', fontWeight: 400 }}>
                      <Clock size={18} />
                      Office Hours
                    </p>
                    <div className="space-y-1 text-sm">
                      <div className="grid grid-cols-2 gap-2 max-w-xs mx-auto lg:mx-0">
                        ...
                        <span className="text-left" style={{ fontWeight: 400 }}>8:00 am - 7:00 pm</span>
                      </div>
                    </div>
